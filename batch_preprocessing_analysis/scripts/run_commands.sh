...
# Command 3
spark-submit --packages com.datastax.spark:spark-cassandra-connector_2.12:3.3.0,com.github.jnr:jnr-posix:3.1.7 --master local[*] /app/batch_analysis.py --input_path file:///input/preprocessed